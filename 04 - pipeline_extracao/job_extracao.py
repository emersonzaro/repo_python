...
# 2 - Remover o caracter "ponto" na última coluna do arquivo para evitar que o número seja truncado 
# 3 - Enriquecer os dados adicionando no destino uma coluna com a margem de lucro de cada produto
